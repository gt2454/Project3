...
public class AndroidAdapter extends RecyclerView.Adapter {
    Context  context;
    List<AndroidBean.ResultsBean> list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_android, null, false);
    ...
    public void setData(List<AndroidBean.ResultsBean> data) {
        if(data.size()>0){
            this.list=data;
        }
    }
       ...
       private final ImageView image;
        ...
        public MyHolder(@NonNull View itemView) {
           ...
           // image = itemView.findViewById(R.id.hot_image);
            ...
            text1 = itemView.findViewById(R.id.android_title1);
            text2 = itemView.findViewById(R.id.android_title2);
            text3= itemView.findViewById(R.id.android_title3);
