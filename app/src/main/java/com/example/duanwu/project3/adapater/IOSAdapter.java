...
public class IOSAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.item_ios, null, false);
    ...
    public void setData(List<IOSBean.ResultsBean> data) {
        if(data.size()>0){
            this.list=data;
        }
    }
       ...
       private final ImageView image;
        ...
        public MyHolder(@NonNull View itemView) {
           ...
           // image = itemView.findViewById(R.id.hot_image);
            image = itemView.findViewById(R.id.ios_image);
            text1 = itemView.findViewById(R.id.ios_title1);
            text2 = itemView.findViewById(R.id.ios_title2);
            text3= itemView.findViewById(R.id.ios_title3);
